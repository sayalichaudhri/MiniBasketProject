...
public class VerifyLogo extends Base {
	...
	public void etsyVerifyLogo() throws IOException {
		...
		BufferedImage expectedImage = null;
		 ...
		 //write image for check logo
	        ...
	        File f = new File("C:\\Users\\Admin\\eclipse-workspace\\EtsyFramework\\Images\\imagesEtsylogo.png");
	...
	//Read image
		try {
			 expectedImage= ImageIO.read(new File("C:\\Users\\Admin\\eclipse-workspace\\EtsyFramework\\Images\\imagesEtsylogo.png"));
		} catch (IOException e) {
